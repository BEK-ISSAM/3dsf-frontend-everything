                    ...
                    <div className="md:7/12 lg:w-1/2">
                        ...
                        <div className="divide-y space-y-4 divide-gray-100 ">
                            ...
                            <div className="pt-4 flex gap-4 md:items-center">
                                ...
                                <div className="w-5/6">
                                    <h4 className="font-semibold text-lg text-gray-700 ">Share Location</h4>
                                    <p className="text-gray-500 ">Share location with people, meet and learn together in groups</p>
                                </div>
                            </div>
                        </div>
                    </div>
