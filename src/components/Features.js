        ...
        <div id="features" className={"text-black"}>
            <Container>
                <div className="md:w-2/3 lg:w-1/2">
                    ...
                    <p className="text-gray-600 ">trying to make your studies efficient and followed.</p>
                </div>
                <div
                    className="mt-16 grid divide-x divide-y divide-gray-700 overflow-hidden rounded-3xl border border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4"
                >
                    <div className="group relative bg-secondary-3 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10">
                        <div className="relative space-y-8 py-12 p-8">
                            ...
                            <div className="space-y-2">
                                <h5
                                    className="text-xl font-semibold text-white transition group-hover:text-secondary"
                                >
                                    Measured Progress
                                </h5>
                    ...
                    <div
                        className="group relative bg-secondary-3 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10"
                    >
                        <div
                            className="relative space-y-8 py-12 p-8 transition duration-300 group-hover:bg-gray-800"
                        >
                            <img
